<div class="container">
    <div class="row">
        ...
        foreach ($this->db->get('bahan')->result() as $post) {
            foreach ($this->db->get_where('user', array('id' => $post->supplier))->result() as $parseUser) {
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="input-group">
                                <input type="number" class="custom-select" name="kuantitas" value="0" min="1"
                                       onchange="activate<?php echo $post->id; ?>()">
                                ...
                                <div class="input-group-a=pend">
                                    ...
                                    <button class="btn btn-outline-secondary" id="commitButton<?php echo $post->id; ?>"
                                            disabled type="submit">Add
                                    </button>
                                </div>
                            </div>
                        </li>
...
<button type="button" class="btn btn-primary" style="position: fixed; right: 15px; bottom: 15px; z-index: 5"
